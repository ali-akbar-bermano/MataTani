...
export const PestEncyclopedia: React.FC<PestEncyclopediaProps> = ({
  ...
  const cropTabs = ['Semua', 'Padi', 'Cabai', 'Tomat', 'Jagung', 'Kentang', 'Anggur', 'Stroberi', 'Tanah'];
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <div className="flex items-center gap-2 mt-1.5 flex-wrap">
              <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-blue-50 border border-blue-200 text-[10px] font-bold text-blue-700">
                <Sparkles className="w-3 h-3" />
                Sumber: PlantVillage Dataset (Kaggle)
              </span>
              <span className="text-[10px] text-slate-400 font-medium">{ENCYCLOPEDIA_DATA.length} entri penyakit</span>
            </div>
          </div>
        </div>
            ...
            <div>
              ...
              <div className="relative h-44 w-full overflow-hidden bg-slate-100">
                ...
                <div className="absolute top-3 left-3 flex items-center gap-1.5 flex-wrap">
                  ...
                  {entry.dataSource && (
                    <span className="bg-blue-600/90 text-white text-[10px] font-bold px-2 py-0.5 rounded-full backdrop-blur-xs">
                      Kaggle
                    </span>
                  )}
                </div>

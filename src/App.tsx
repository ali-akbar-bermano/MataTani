          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
            ...
            <div className="flex flex-col items-center sm:items-end gap-3 text-center sm:text-right">
              <div className="text-xs text-emerald-200/70 space-y-1">
                <p className="font-semibold text-emerald-300">Dikembangkan oleh:</p>
                <p>Ali Akbar Bermano</p>
                <p>Naifah Amanda Noveni</p>
                <p>Ludvie Pradya Paramitha</p>
              </div>
              <p className="text-xs text-emerald-200/50 max-w-xs">
                MataTani hadir untuk membantu petani Indonesia mendeteksi penyakit tanaman lebih cepat, akurat, dan berkelanjutan berbasis kecerdasan buatan.
              </p>
